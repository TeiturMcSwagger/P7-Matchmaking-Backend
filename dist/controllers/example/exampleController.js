...
let ExampleController = class ExampleController {
    ...
    exampleRouteFunction(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let service = new exampleService_1.ExampleService();
            res.json(yield this.bookService.getAllBooks());
        });
    }
};
__decorate([
...
], ExampleController.prototype, "exampleRouteFunction", null);
ExampleController = __decorate([
    inversify_express_utils_1.controller("/"),
    __param(0, inversify_1.inject(interfaces_1.TYPES.BookService)),
